    ...
    <td>
        <div role="banner">
            ...
            <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
                <div class="logo-center" id="emb-email-header" align="center"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 156px;" src="https://i.imgur.com/XTTLSz9.png" alt="" width="156"></div>
            </div>
            <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
            </div>
        </div>
        <div role="section">
        <div style="background-color: #348cd9;">
            ...
            <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-full-width" style="background-color: #348cd9;"><td class="layout__edges">&nbsp;</td><td style="width: 200px" valign="top" class="w160"><![endif]-->
        ...
        <div style="background-color: #348cd9;">
            ...
            <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
            <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-full-width" style="background-color: #348cd9;"><td class="layout__edges">&nbsp;</td><td style="width: 600px" class="w560"><![endif]-->
        ...
        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
            <p class="size-22" style="Margin-top: 0;Margin-bottom: 20px;font-family: avenir,sans-serif;font-size: 18px;line-height: 26px;text-align: center;" lang="x-size-22"><span class="font-avenir"><span style="color:#348cd9"><strong>Tu código de recuperación es {{ $code }}.</strong></span></span></p>
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;line-height: 130px;font-size: 1px;">&nbsp;</div>
        </div>
